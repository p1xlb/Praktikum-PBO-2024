...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        pilotList.add(new pilot("P4", "Fahri P", "Global 7500", 4000));
        pilotList.add(new pilot("P5", "Fajar P", "Global 7500", 5000));
        ...
        mekanikList.add(new mekanik("M3", "Udin M", "Global 7500", "Engine"));
